...
@SourceType(value = "ADLSARP", label = "ADLS",uiConfig = "adls-layout.json")
public class ADLSConf extends AbstractArpConf<ADLSConf> {
  private static final String ARP_FILENAME = "arp/implementation/adls-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.adls.ADLSDriver";
